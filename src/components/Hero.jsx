  ...
  return (
    <div className='bg-orange-50 h-[600px]'>
        <div className='flex lg:flex-row flex-col items-center justify-center p-5 lg:max-w-7xl mx-auto relative'>
            ...
            <p className='text-sm text-gray-600 my-3'>Discover a World of culinary delights with our food delivery service. Enjoy fast,reliable delivery and a wide selection of dishes. </p>
            <div className='flex gap-3'>
                ...
                <button className='bg-white px-3 py-2 rounded-lg border border-red-400 text-red-500 hover:bg-white hover:scale-110 transition-all'>Contact now</button>
            </div>
            </div>
            <div className='lg:w-1/2 w-[275px] relative'>
                ...
                <div  className='bg-red-50 leading-none flex flex-col gap-1 ext-lg px-4 py-2 border-red-200 border absolute top-10
                right-36 rounded-full items-center'>
                ...
                <img src={tomatocut} alt="tomatocut" className='hidden lg:block absolute w-32 bottom-20 left-4'/>
            </div>
        </div>
        <img src={cabbage} alt='cabbage ' className='absolute top-79 lg:top-[410px] left-3 w-20 lg:w-44 z-0' />
    </div>
  )
}
