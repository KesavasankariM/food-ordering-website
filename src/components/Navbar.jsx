    ...
    <header className={`sticky mx-auto top-0 z-30 bg-orange-100 border-2 border-orange-200 transition-all ${header ? 'py-4 bg-orange-100 shadow-lg ' : 'py-6'} `}>
      <div className="max-w-7xl mx-auto ">
        ...
        className='md:hidden p-4  bg-orange-100 rounded-lg font-semibold text-xl mt-2 flex flex-col gap-2 text-center'>
          <li className='cursor-pointer hover:text-red-500' to={'/'}>Home</li>
          <li className='cursor-pointer hover:text-red-500' to={'#menu'}>Menu</li>
          <li className='cursor-pointer hover:text-red-500' to={'#about'}>About</li>
          <li  className='cursor-pointer hover:text-red-500' to={'#contact'}>Contact</li>
